    ...
    <div class="tbox post-list">
        <table class="post border">
            <tr>
                <td class="post-left-column header">
                    <div>
                    <!-- 查看：<span><?php //echo $postmodel->post_view_count;?></span>回复：<span><?php //echo $postmodel->post_reply_count;?></span> -->
                                                            查看：<span><?php echo AdPost::getViewCount($postmodel->post_id);?></span>回复：<span><?php echo $postmodel->post_reply_count;?></span>
                    </div>
                </td>
        ...
        <div id="post_<?php echo $row['reply_id'];?>">
            <table class="post border">
                ...
                <?php if($row['reply_user_id']==Ad::getIdentity()->id):?>
                <tr>
