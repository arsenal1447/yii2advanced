...
class BaseController extends Controller
{
    ...
    public function getCachedRoles($roleName = null)
    {
        ...
        {
            $this->_cachedRoles = Ad::getAppParam('cachedRoles');
        }
        if ($roleName !== null)
        {
    ...
    public function getCachedRoleGroups($groupName = null)
    {
        ...
        {
            $this->_cachedRoleGroups = Ad::getAppParam('cachedRoleGroups');
        }
    ...
    public function getCachedPermissions($permissionName = null)
    {
        ...
        {
            $this->_cachedPermissions = Ad::getAppParam('cachedPermissions');
        }
    ...
    public function getCachedPermissionCategories()
    {
        ...
        {
            $this->_cachedPermissionCategories = Ad::getAppParam('cachedPermissionCategories');
        }
    ...
    public function getCachedBoards()
    {
        ...
        {
            $this->_cachedBoards = Ad::getAppParam('cachedBoards');
        }
