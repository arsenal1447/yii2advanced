...
?>
    <div style="width:100%;margin:0 25%;">
        ...
        <?php echo empty($model->name) ? Html::beginForm([ 'create-item','type'=>$type],'post') :
            ...
            <div class="list-group-item">
                <?php echo Html::label('规则名称：',null,['class'=>'col-md-3']).Html::textInput('ruleName',$model->ruleName);?>
            </div>
            <div class="list-group-item">
                <?php echo Html::label('数据：',null,['class'=>'col-md-3']).Html::textInput('data',$model->data);?>
            </div>
            <div class="list-group-item">
                <?php echo Html::label('描述：',null,['class'=>'col-md-3']).Html::textarea('description',$model->description);?>
            </div>
            <div class="list-group-item">
